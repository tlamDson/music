...
export default function TracksPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      >
        <svg viewBox="0 0 24 24" className="w-12 h-12" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ color: dragOver ? 'var(--color-accent)' : 'rgba(248,250,252,0.3)' }}>
        ...
        <div className="text-center">
          ...
          <p className="text-xs mt-1" style={{ color: 'rgba(248,250,252,0.5)' }}>
            MP3, WAV, FLAC, OGG supported · Max 50MB
          </p>
        </div>
        <input
          ref={fileInputRef}
      ...
      <div>
        ...
        {loading ? (
          ...
          <p className="text-sm" style={{ color: 'rgba(248,250,252,0.5)' }}>No tracks yet. Upload your first audio file above.</p>
        ) : (
            ...
            {tracks.map((track, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="text-xs w-6 text-right" style={{ color: 'rgba(248,250,252,0.4)' }}>
                    {i + 1}
                  </span>
                  <div>
                    <p className="text-sm font-medium" style={{ color: 'var(--color-foreground)' }}>
